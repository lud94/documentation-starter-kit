...
const NAV: NavItem[] = [
  ...
  { href: '/missions', label: 'Missions', ready: true, icon: icon('M13 10V3L4 14h7v7l9-11h-7z') },
  { href: '/lists', label: 'Listes', ready: true, icon: icon('M4 6h16M4 10h16M4 14h10M4 18h10') },
