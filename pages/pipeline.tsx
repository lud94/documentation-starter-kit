...
function LeadCard({ lead }: { lead: Lead }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-3 hover:shadow-sm hover:border-gray-200 transition-all cursor-pointer">
      ...
      <div className="flex items-center justify-between mt-2.5">
        ...
        <span className="flex items-center gap-1.5 flex-shrink-0">
          ...
          <span className="text-xs font-semibold text-gray-500">{lead.score}</span>
        </span>
      </div>
    </div>
  )
